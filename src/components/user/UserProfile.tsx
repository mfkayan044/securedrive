...
const UserProfile: React.FC<UserProfileProps> = ({ onClose }) => {
  const { currentUser, userReservations, updateProfile, logout } = useUser();
                    ...
                    <div key={reservation.id} className="bg-gray-50 rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-blue-600">{reservation.totalPrice} ₺</p>
                        </div>
                      </div>
              ...
              <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg p-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-blue-100">Toplam puanınız</p>
                  </div>
